...
SLASH_HELLO_WORLD_HELP1="/hwhelp"
SlashCmdList["HELLO_WORLD_HELP"]=function(msg)
    for key, value in pairs(HelloWorld_Text) do
        SendChatMessage(key .. " " .. value,channel)
    end
end
